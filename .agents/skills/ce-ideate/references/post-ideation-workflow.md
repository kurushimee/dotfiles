...
- **unjustified — no articulated basis** (fork failed to provide `direct:`, `external:`, or `reasoned:` justification, or the stated basis does not actually support the claimed move)
...
- if forks were used, they improved diversity without replacing the core workflow
