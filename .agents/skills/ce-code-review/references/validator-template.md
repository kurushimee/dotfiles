# Validator Fork Prompt Template

This template is used by Stage 5b to dispatch one validator fork per surviving finding before externalization. The validator's job is **independent re-verification**, not re-reasoning. It is a fresh second opinion, not a critic of the original persona's analysis.
