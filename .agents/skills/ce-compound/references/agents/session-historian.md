...
- **Never invoke the Skill tool.** This agent runs in fork context where Skill calls deadlock. The orchestrator has already done all extraction; you only synthesize.
